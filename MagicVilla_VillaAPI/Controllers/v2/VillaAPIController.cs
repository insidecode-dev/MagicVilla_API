    ...
    public class VillaAPIController : ControllerBase
    {
        ...
        public async Task<ActionResult<ApiResponse>> CreateVillaAsync([FromForm] VillaCreateDTO createDTO)
        {
            try
            {
                ...
                if (createDTO.Image!=null)
                {
                    ...
                    string fileName = villa.Id.ToString()+Path.GetExtension(createDTO.Image.FileName);
                    ...
                    // checking if a file in such directory is exists, if yes, deleting
                ...
                {
                    villa.ImageUrl = "htttps://placehold.co/600x400";
                }
        ...
        public async Task<ActionResult<ApiResponse>> DeleteVillaAsync(int id)
        {
            try
            {
                ...
                {
                    var pathDirectory = Path.Combine(Directory.GetCurrentDirectory(), villa.ImageLocalPath);
                    FileInfo file = new FileInfo(pathDirectory);
                    if (file.Exists)
                    {
                        file.Delete();
                    }
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<ApiResponse>> UpdateVillaAsync(int id, [FromForm] VillaUpdateDTO updateDTO)
        {
            try
            {   
                ...
                {
                    updatedVilla.ImageUrl = "htttps://placehold.co/600x400";
                }
